...
export default function PhoneNumbersView() {
  ...
  return (
    <main className=" flex h-full bg-gray-50 dark:bg-gray-900 dark:text-gray-100 -m-8 bottom-0 inset-0">
      ...
      <div className="w-80 bg-white border-r border-gray-200 flex flex-col dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="p-4 mb-2 border-b justify-between gap-2 items-center flex border-gray-200 dark:border-gray-700">
          ...
          <h2 className="text-md font-bold mb-4 my-auto">{formData?.phoneNumber || 'Add New Number'}</h2>
           ...
           type='button' 
           className="px-2 py-[8px] cursor-pointer dark:bg-black bg-gray-300 hover:bg-gray-900 text-black hover:text-white dark:text-gray-200 rounded-lg flex items-center gap-2">
                  <Plus className="w-4 h-4 dark:text-gray-300 text-gray-200 hover:text-white/70" />
                  Add
                </button>
          </div>
